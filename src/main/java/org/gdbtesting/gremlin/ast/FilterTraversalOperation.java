...
public class FilterTraversalOperation extends Traversal{
    ...
    public enum Filter{
        ...
        where_traversal("where_traversal"), //where(Traversal)
...
//        range("range"),
        ...
        Filter(String filter){this.filter = filter;}
...
//        where_predicate("where_predicate"), //where(Predicate)
    ...
    public static class Limit extends FilterTraversalOperation{
        private int limit;
    ...
    public static class Range extends FilterTraversalOperation{
        private int low;
        private int high;
    ...
    public static class Tail extends FilterTraversalOperation{
        private int tail;
        public Tail(int tail){this.tail = tail;}
        @Override
        public String toString(){
            return "tail(" + tail + ")";
        }
    ...
    public static class IsPredicate extends  FilterTraversalOperation{
        ...
        public Predicate getValue(){return predicate;}
    ...
    public static class WhereTraversal extends  FilterTraversalOperation{
        ...
        public Traversal getValue(){return traversal;}
    ...
    public static Or createOr(Traversal traversal){ return  new Or(traversal);}
    public static And createAnd(Traversal traversal){ return new And(traversal);}
    public static Not createNot(Traversal traversal){ return new Not(traversal);}
    public static WhereTraversal createWhereTraversal(Traversal traversal){ return new WhereTraversal(traversal);}
    public static WherePredicate createWherePredicate(Predicate predicate){return new WherePredicate(predicate);}
    public static Is createIs(Object object){return new Is(object);}
    public static IsPredicate createIsPredicate(Predicate predicate){return new IsPredicate(predicate);}
    public static HasKeyValue createHasKeyValue(String key, Object value){return new HasKeyValue(key,value);}
    public static HasKeyPredicate createHasKeyPredicate(String key, Predicate predicate){return new HasKeyPredicate(key, predicate);}
    ...
    public static HasLabelKeyValue createHasLabelKeyValue(String label, String key, Object value){return new HasLabelKeyValue(label, key, value);}
    public static HasKeyTraversal createHasKeyTraversal(String key, Traversal traversal){return new HasKeyTraversal(key, traversal);}
    public static HasKey createHasKey(String key){return new HasKey(key);}
    public static HasNotKey createHasNotKey(String key){return new HasNotKey(key);}
    public static HasLabel createHasLabel(List<String> label){return new HasLabel(label);}
    public static HasId createHasId(List<Object> id){return new HasId(id);}
    ...
    public static Limit createLimit(int limit){return new Limit(limit);}
    public static Range createRange(int low, int high){return new Range(low, high);}
    public static Tail createTail(int tail){return new Tail(tail);}
}
