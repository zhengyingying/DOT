...
public class NeighborTraversalOperation extends Traversal implements GraphExpression{
    ...
    public enum NeighborV{
        ...
        NeighborV(String neighbor){this.neighbor = neighbor;}
    ...
    public enum NeighborE{
        ...
        NeighborE(String neighbor){this.neighbor = neighbor;}
    ...
    public static Out createOut(List<String> edgeLabels){return new Out(edgeLabels);}
    public static In createIn(List<String> edgeLabels){return new In(edgeLabels);}
    public static Both createBoth(List<String> edgeLabels){return new Both(edgeLabels);}
    public static OutE createOutE(List<String> edgeLabels){return new OutE(edgeLabels);}
    public static InE createInE(List<String> edgeLabels){return new InE(edgeLabels);}
    public static BothE createBothE(List<String> edgeLabels){return new BothE(edgeLabels);}
    public static OutV createOutV(){return new OutV();}
