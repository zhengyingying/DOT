...
public class StatisticTraversalOperation extends Traversal{
    ...
    public enum AggregateOperator{
        ...
        AggregateOperator(String text){this.text = text;}
    ...
    public static Count createCount(){return new Count();}
    public static Sum createSum(){return new Sum();}
    public static Mean createMean(){return new Mean();}
    public static Max createMax(){return new Max(); }
