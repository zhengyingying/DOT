...
public class UnaryPrefixOperation extends UnaryPrefixOperatorNode<GraphExpression> implements GraphExpression {
    ...
    public enum EmunUnaryPrefixOperator implements Operator {
        ...
        EmunUnaryPrefixOperator(String textRepresentation){this.textRepresentation = textRepresentation;}

        public static EmunUnaryPrefixOperator getRandom(){return Randomly.fromOptions(values());
        }
